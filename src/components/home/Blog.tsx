            ...
            <article className="card-lift group relative h-full overflow-hidden rounded-[2rem] bg-card shadow-soft">
              ...
              <div className="p-7">
                <p className="text-xs font-semibold tracking-wide text-muted-foreground uppercase">
                  {posts[0].fecha} · {posts[0].lectura} de lectura
                </p>
                <h3 className="mt-3 text-2xl leading-tight font-extrabold sm:text-3xl">{posts[0].titulo}</h3>
                <p className="mt-3 leading-relaxed text-muted-foreground">{posts[0].resumen}</p>
